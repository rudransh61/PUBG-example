...
parcelHelpers.export(exports, "handleStateChange", ()=>handleStateChange);
var _upkaranJs = require("./Upkaran.js");
var _appJs = require("./App.js");
var _stateJs = require("./state.js"); // Import the createState function
...
},{"./Upkaran.js":"feRlQ","./App.js":"2kQhy","./state.js":"j3t7q","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"feRlQ":[function(require,module,exports) {
// Upkaran.js
    ...
    function update() {
        ...
        components.forEach((component)=>{
            ...
            if (component.style) {
                ...
                for(const property in component.style)// Check if the property exists in the style object
                if (component.style.hasOwnProperty(property)) // Apply the style to the newElement
...
function App() {
    ...
    return {
        ...
        content: [
            ...
            (0, _listComponentJs.ListComponent)(state.getState().todos) // Pass todos to ListComponent
        ]
    };
}

},{"./state.js":"j3t7q","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./Component/ListComponent.js":"mUc1k"}],"j3t7q":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function createState(initialState) {
    ...
    function setState(newState) {
        ...
        this.subscribe((0, _indexJs.handleStateChange));
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./index.js":"8lqZg"}],"mUc1k":[function(require,module,exports) {
// Component/ListComponent.js
// Define ListComponent
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ListComponent", ()=>ListComponent);
function ListComponent(todos, removeTodo) {
